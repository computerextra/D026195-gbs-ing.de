    ...
    >
      ...
      <ModalBody>
        ...
        <p>
          ...
          Webseitenbetreiber. Dessen Kontaktdaten können Sie dem Abschnitt
        ...
        <h3>All-Inkl</h3>
        <p>
          Anbieter ist die ALL-INKL.COM - Neue Medien Münnich, Inh. Ren&eacute;
        ...
        <p>
          ...
          auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1
        ...
        <p>
          ...
          Endgerät (z.&nbsp;B. via Device-Fingerprinting) eingewilligt haben,
          erfolgt die Datenverarbeitung zusätzlich auf Grundlage von &sect; 25
          Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre
          ...
          Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. Über die jeweils
          im Einzelfall einschlägigen Rechtsgrundlagen wird in den folgenden
        ...
        <p>
          ...
          haben, dürfen diese Daten &ndash; von ihrer Speicherung abgesehen
          &ndash; nur mit Ihrer Einwilligung oder zur Geltendmachung, Ausübung
          ...
          eines wichtigen öffentlichen Interesses der Europäischen Union oder
